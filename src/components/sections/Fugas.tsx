    ...
    <section id="fugas" className="w-full bg-canvas py-20 md:py-28">
      <div className="max-w-5xl mx-auto px-6">
        <div className="reveal max-w-2xl">
          <h2 className="font-sans font-bold text-ink leading-[1.15] text-[clamp(1.75rem,4vw,2.5rem)] whitespace-pre-line text-balance">
            {fugas.headlinePre}
            <em className="font-serif italic font-medium">{fugas.headlineEmphasis}</em>
          </h2>
          <p className="mt-5 font-sans text-ink-secondary leading-relaxed">{fugas.subhead}</p>
        </div>
        ...
        <p className="reveal mt-12 font-serif italic text-ink text-xl md:text-2xl max-w-2xl whitespace-pre-line">
          {fugas.remate}
        </p>
