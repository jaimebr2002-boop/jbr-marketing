...
export const sistemas = {
  ...
  items: [
    ...
    { name: 'Radiografía 360', tag: 'auditoría técnica y estratégica a medida', resuelve: 'Decisiones tomadas sin saber en qué punto está realmente el negocio ni qué resolver primero.' },
    { name: 'Playbook Operativo', tag: 'documentación y formación de adopción', resuelve: 'Herramientas ya implementadas que el equipo abandona a las pocas semanas.' },
  ],
