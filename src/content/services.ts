...
export const SERVICES: ServiceDetail[] = [
  {
    ...
    seoDescription: 'Diseño y desarrollo web a medida desde Oviedo para empresas de toda España: webs rápidas, optimizadas para Google y orientadas a captar clientes.',
  },
  {
    slug: 'redes-sociales',
  ...
  },
  {
    ...
    seoTitle: 'SEO local en Oviedo y Asturias | Jaime Bernáldez',
    seoDescription: 'SEO local para empresas de Oviedo y Asturias: auditoría técnica, contenido y estrategia para aparecer en Google y atraer clientes cercanos.',
  },
  {
    slug: 'geo',
    ...
    seoTitle: 'Posicionamiento GEO e IA para empresas | Jaime Bernáldez',
    seoDescription: 'Optimización GEO para que ChatGPT, Gemini, Perplexity y Google AI Overviews entiendan, citen y recomienden tu empresa.',
  },
  {
  ...
  },
  {
    ...
    seoTitle: 'Automatización de procesos e IA | Jaime Bernáldez',
    seoDescription: 'Automatización de procesos e IA para empresas: conecta CRM, correo, WhatsApp y facturación para reducir trabajo manual desde cualquier lugar.',
  },
  {
  ...
  },
  {
    ...
    seoTitle: 'CRM y ERP para pymes | Jaime Bernáldez',
    seoDescription: 'Implementación e integración de CRM y ERP para pymes, adaptados al proceso real del negocio y conectados con sus herramientas.',
  },
  {
    ...
    seoTitle: 'Software y aplicaciones a medida | Jaime Bernáldez',
    seoDescription: 'Desarrollo de aplicaciones, ERP, CRM y software a medida desde Oviedo para empresas de toda España cuando las herramientas genéricas no encajan.',
  },
  {
    ...
    seoTitle: 'Chatbots y agentes de IA para empresas | Jaime Bernáldez',
    seoDescription: 'Chatbots y agentes de voz con IA para empresas: atención, citas, recordatorios y llamadas conectadas con tus herramientas.',
  },
  {
